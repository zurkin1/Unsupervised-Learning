...
"""
def convert_to_rgb(df, split, resize=True, new_size=300, extension='jpeg'):
    N = df.shape[0]
...
#Since we seprated to two sites, we need to update the lables.
...
if __name__ == '__main__':
    ...
    #train_df = build_new_df(train_df)
    #test_df = build_new_df(test_df)
